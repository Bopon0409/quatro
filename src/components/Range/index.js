...
export default function Range({ min = 1, max = 100, steps = 1, defaultValue = 1, onChange, options = {} }){
    ...
    <div className={styles.field}>
        <input type="range" min={min} max={max} defaultValue={defaultValue} style={InputStyle} onChange={ChangeBackgroundBeforeThumb} className={styles.matherOrFather} />
